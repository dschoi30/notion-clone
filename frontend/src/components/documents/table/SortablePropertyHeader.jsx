  ...
  return (
    ...
    >
      <div
        ...
        className={`flex items-center px-2 w-full transition-colors ${isReadOnly ? '':'hover:bg-gray-50 cursor-grab'}`}
        style={{
      ...
      >
        {editingHeader.id === property.id ? (
          ...
          <div
            ...
            onClick={() => { if (!isReadOnly) setEditingHeader({ id: property.id, name: property.name }); }}
          >
